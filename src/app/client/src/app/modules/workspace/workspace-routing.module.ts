...
import {
  ...
  AllContentComponent, FlagReviewerComponent, CollaboratingOnComponent, AdduserorgComponent} from './components';
import {
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      // }
      {
        path: 'addUsersOrgs', component: AdduserorgComponent, canActivate: [AuthGuard],
        data: {
          telemetry: {
            env: telemetryEnv, pageid: 'workspace-addUserOrg', uri: '/workspace/content/addUsersOrgs',
            type: 'view', mode: 'create', object: { type: objectType, ver: '1.0' }
